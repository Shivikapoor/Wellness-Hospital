...
// node_modules/@paper-design/shaders/dist/shaders/lens-distortion.js
var lensDistortionMeta = {
  maxSamples: 50
};
var lensDistortionFragmentShader = `#version 300 es
precision mediump float;
...
var PaperTexture = (0, import_react22.memo)(function PaperTextureImpl({
  ...
  colorPaper = defaultPreset21.params.colorPaper,
  colorShadow = defaultPreset21.params.colorShadow,
  blending = defaultPreset21.params.blending,
  distortion = defaultPreset21.params.distortion,
  clip = defaultPreset21.params.clip,
  angle = defaultPreset21.params.angle,
  seed = defaultPreset21.params.seed,
  roughness = defaultPreset21.params.roughness,
  roughnessSize = defaultPreset21.params.roughnessSize,
  roughnessRows = defaultPreset21.params.roughnessRows,
  ...
  foldSizeX = defaultPreset21.params.foldSizeX,
  foldSizeY = defaultPreset21.params.foldSizeY,
  foldOffsetX = defaultPreset21.params.foldOffsetX,
  foldOffsetY = defaultPreset21.params.foldOffsetY,
  wrinkles = defaultPreset21.params.wrinkles,
  wrinkleSize = defaultPreset21.params.wrinkleSize,
  crumples = defaultPreset21.params.crumples,
  foldsNumber,
  crumpleCount = foldsNumber === void 0 ? defaultPreset21.params.crumpleCount : foldsNumber,
...
var flutedGlassPresets = [defaultPreset22, abstractPreset, wavesPreset, foldsPreset];
...
var waterPresets = [defaultPreset23, slowMoPreset, abstractPreset2, streamingPreset];
...
// node_modules/@paper-design/shaders-react/dist/shaders/lens-distortion.js
...
var lensDistortionPresets = [
  defaultPreset25,
  fisheyePreset,
  duotonePreset,
  smokePreset
];
var LensDistortion = (0, import_react26.memo)(function LensDistortionImpl({
  // Own props
  speed = defaultPreset25.params.speed,
  frame = defaultPreset25.params.frame,
  image = "",
  spread = defaultPreset25.params.spread,
  bias = defaultPreset25.params.bias,
  angle = defaultPreset25.params.angle,
  perspective = defaultPreset25.params.perspective,
  count = defaultPreset25.params.count,
  dispersion = defaultPreset25.params.dispersion,
  dispersionShift = defaultPreset25.params.dispersionShift,
  dispersionColor = defaultPreset25.params.dispersionColor,
  focusCenter = defaultPreset25.params.focusCenter,
  focusEdges = defaultPreset25.params.focusEdges,
  swirl = defaultPreset25.params.swirl,
  noise = defaultPreset25.params.noise,
  noiseFrequency = defaultPreset25.params.noiseFrequency,
  noiseOffset = defaultPreset25.params.noiseOffset,
  lensBulge = defaultPreset25.params.lensBulge,
  lensCircle = defaultPreset25.params.lensCircle,
  grainMixer = defaultPreset25.params.grainMixer,
  grainOverlay = defaultPreset25.params.grainOverlay,
  imageX = defaultPreset25.params.imageX,
  imageY = defaultPreset25.params.imageY,
  // Sizing props
...
var heatmapPresets = [defaultPreset26, sepiaPreset];
var Heatmap = (0, import_react27.memo)(function HeatmapImpl({
  // Own props
  ...
  noise = defaultPreset26.params.noise,
  innerGlow = defaultPreset26.params.innerGlow,
  outerGlow = defaultPreset26.params.outerGlow,
  colorBack = defaultPreset26.params.colorBack,
  colors = defaultPreset26.params.colors,
  ...
  const uniforms = (0, import_react27.useMemo)(
    () => ({
      // Own uniforms
...
var liquidMetalPresets = [defaultPreset27, noirPreset, fullScreenPreset, stripesPreset];
var LiquidMetal = (0, import_react28.memo)(function LiquidMetalImpl({
  // Own props
  colorBack = defaultPreset27.params.colorBack,
  colorTint = defaultPreset27.params.colorTint,
  speed = defaultPreset27.params.speed,
  frame = defaultPreset27.params.frame,
  image = "",
  contour = defaultPreset27.params.contour,
  distortion = defaultPreset27.params.distortion,
  softness = defaultPreset27.params.softness,
  repetition = defaultPreset27.params.repetition,
  shiftRed = defaultPreset27.params.shiftRed,
  shiftBlue = defaultPreset27.params.shiftBlue,
  angle = defaultPreset27.params.angle,
  shape = defaultPreset27.params.shape,
  suspendWhenProcessingImage = false,
  // Sizing props
  ...
  const imageUrl = typeof image === "string" ? image : image.src;
  const [processedStateImage, setProcessedStateImage] = (0, import_react28.useState)(transparentPixel);
  let processedImage;
...
var halftoneDotsPresets = [defaultPreset28, ledPreset, netPreset, roundAndSquarePreset];
var HalftoneDots = (0, import_react29.memo)(function HalftoneDotsImpl({
  // Own props
  speed = defaultPreset28.params.speed,
  frame = defaultPreset28.params.frame,
  colorFront = defaultPreset28.params.colorFront,
  colorBack = defaultPreset28.params.colorBack,
  image = "",
  size = defaultPreset28.params.size,
  radius = defaultPreset28.params.radius,
  contrast = defaultPreset28.params.contrast,
  originalColors = defaultPreset28.params.originalColors,
  inverted = defaultPreset28.params.inverted,
  ...
  grid = defaultPreset28.params.grid,
...
var halftoneCmykPresets = [defaultPreset29, dropsPreset, newspaper, vintagePreset];
var HalftoneCmyk = (0, import_react30.memo)(function HalftoneCmykImpl({
  // Own props
  speed = defaultPreset29.params.speed,
  frame = defaultPreset29.params.frame,
  colorBack = defaultPreset29.params.colorBack,
  colorC = defaultPreset29.params.colorC,
  colorM = defaultPreset29.params.colorM,
  colorY = defaultPreset29.params.colorY,
  colorK = defaultPreset29.params.colorK,
  image = "",
  size = defaultPreset29.params.size,
  contrast = defaultPreset29.params.contrast,
  softness = defaultPreset29.params.softness,
  grainSize = defaultPreset29.params.grainSize,
  grainMixer = defaultPreset29.params.grainMixer,
  grainOverlay = defaultPreset29.params.grainOverlay,
  gridNoise = defaultPreset29.params.gridNoise,
  floodC = defaultPreset29.params.floodC,
  floodM = defaultPreset29.params.floodM,
  floodY = defaultPreset29.params.floodY,
  floodK = defaultPreset29.params.floodK,
  gainC = defaultPreset29.params.gainC,
  gainM = defaultPreset29.params.gainM,
  gainY = defaultPreset29.params.gainY,
  gainK = defaultPreset29.params.gainK,
  type = defaultPreset29.params.type,
  // Sizing props
...
var gemSmokePresets = [defaultPreset30, firePreset, fluorescentPreset, infraredPreset];
var GemSmoke = (0, import_react31.memo)(function GemSmokeImpl({
  // Own props
  colorBack = defaultPreset30.params.colorBack,
  colors = defaultPreset30.params.colors,
  speed = defaultPreset30.params.speed,
  frame = defaultPreset30.params.frame,
  image = "",
  innerDistortion = defaultPreset30.params.innerDistortion,
  outerDistortion = defaultPreset30.params.outerDistortion,
  outerGlow = defaultPreset30.params.outerGlow,
  innerGlow = defaultPreset30.params.innerGlow,
  colorInner = defaultPreset30.params.colorInner,
  offset = defaultPreset30.params.offset,
  angle = defaultPreset30.params.angle,
  size = defaultPreset30.params.size,
  shape = defaultPreset30.params.shape,
  suspendWhenProcessingImage = false,
  // Sizing props
  fit = defaultPreset30.params.fit,
  scale = defaultPreset30.params.scale,
  rotation = defaultPreset30.params.rotation,
  originX = defaultPreset30.params.originX,
  originY = defaultPreset30.params.originY,
  offsetX = defaultPreset30.params.offsetX,
  offsetY = defaultPreset30.params.offsetY,
  worldWidth = defaultPreset30.params.worldWidth,
  worldHeight = defaultPreset30.params.worldHeight,
  ...props
}) {
  const imageUrl = typeof image === "string" ? image : image.src;
  const [processedStateImage, setProcessedStateImage] = (0, import_react31.useState)(transparentPixel);
  let processedImage;
  if (suspendWhenProcessingImage && typeof window !== "undefined" && imageUrl) {
    processedImage = suspend(
